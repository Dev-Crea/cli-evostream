...
def create_package(target)
  ...
  sh "cp cli.rb #{package_dir}/lib/app/"
  sh "cp argument.rb #{package_dir}/lib/app/"
  sh "cp command.rb #{package_dir}/lib/app/"
  sh "cp evostream-cli.rb #{package_dir}/lib/app/"
  sh "cp help #{package_dir}/lib/app/"
